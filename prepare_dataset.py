...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='div2k', type=str, required=True, help='Dataset name.')
    parser.add_argument('--scale', default=2, type=int, required=True, help='Scale Factor')
